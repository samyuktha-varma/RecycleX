# RecycleX - Smart Waste Management System
...
* **Backend Architecture:** Node.js, Express.js REST APIs, Cross-Origin Resource Sharing (CORS) management.
* **Database Integration:** Local Oracle Database connection pools for robust user data logging.
* **Automation:** Integrated cron job schedulers for processing automated timing queues.
